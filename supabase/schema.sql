...
-- ============================================================
-- campaign_broadcasters: per-campaign Twitch broadcaster credentials
-- so the broadcast channel (chat target, sub source) can be a
-- different Twitch account than the GM signed in via Supabase.
-- ============================================================
